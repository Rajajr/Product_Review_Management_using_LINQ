    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Productreview> productreviewlist = new List<Productreview>()
            {
                ...
                new Productreview() { ProductID = 3, UserID = 3, Rating = 4, Review = "Good", is_Like = true },
                new Productreview() { ProductID = 4, UserID = 4, Rating = 2, Review = "Good", is_Like = true },
                new Productreview() { ProductID = 5, UserID = 5, Rating = 5, Review = "Good", is_Like = true },
                ...
                new Productreview() { ProductID = 11, UserID = 3, Rating = 4, Review = "nice", is_Like = true },
                new Productreview() { ProductID = 10, UserID = 4, Rating = 2, Review = "nice", is_Like = true },
                new Productreview() { ProductID = 12, UserID = 5, Rating = 5, Review = "nice", is_Like = true },
